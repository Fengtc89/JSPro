var peckerwood = function (R) {
    ...
    function f(e, t) {
        if (a(e))
            ...
            for (var o in e) z(e, o) && t.call(null, e[o], o, e)
    }

    function d(e) {
        for (var n, r, t = [], o = 1; o < arguments.length; o++) t[o - 1] = arguments[o];
        return r = V(e) ? (n = e, t.shift()) : e,
            f(t, function (e) {
                f(e, function (e, t) {
                    n && (a(e) || g(e)) ? (a(e) ? a(r[t]) || (r[t] = []) : g(r[t]) || (r[t] = {}), d(n, r[t], e)) : r[t] = e
                })
            }),
            r
    }
        ...
        try {
            ...
            if (e && ("object" == typeof e || "function" == typeof e)) {
                ...
                if (e instanceof i) return t._state = 3,
                    t._value = e,
                    void ce(t);
                if ("function" == typeof n) return void pe((r = n, o = e, function () {
                    r.apply(o, arguments)
                }), t)
            }
            t._state = 1,
    ...
    function ce(e) {
        ...
        for (var t = 0, n = e._deferreds.length; t < n; t++) ie(e, e._deferreds[t]);
        e._deferreds = null
    }
    ...
    i.prototype.
        ...
        i.all = function (t) {
            return new i(function (o, i) {
                if (!re(t)) return i(new TypeError("Promise.all accepts an array"));
        ...
        i.race = function (o) {
            return new i(function (e, t) {
                if (!re(o)) return t(new TypeError("Promise.race accepts an array"));
            ...
            for (var n in e)
                if (z(e, n)) {
                    ...
                    if (e[n] !== t[n]) {
                        ...
                        if (!le(e[n], t[n])) return
                    }
                }
            for (n in t)
                if (z(t, n) && !z(e, n)) return;
            return 1
        }
    }
    "function" != typeof r.Promise ? r.Promise = i : (r.Promise.prototype.
        finally || (r.Promise.prototype.
            finally = X), r.Promise.allSettled || (r.Promise.allSettled = Z), r.Promise.any || (r.Promise.any = te));
    (r = {}).rejected = "reject",
        r.resolved = "resolve";
    var fe = r,
        de = (he.prototype.push = function (e) {
            ...
            this.queue.forEach(function (e) {
                ...
                this.options.stateful && (this.status = t, this.args = n, this.queue.length = 0)
        }, he);
    ...
    ye.prototype.on = function (e, t, n) {
        ...
        if ("function" == typeof t) {
            if (n && r.__emited) return t.call(void 0, r.__args),
                this;
            r.push(t),
                this.handlers[e] = r
        }
        ...
        ye.prototype.emit = function (e, t) {
            ...
            return n && (n.forEach(function (e) {
                e.call(void 0, t)
            }), n.__args = t, n.__emited = !0, this.handlers[e] = n),
                this
        },
    ...
    var _e, we, m = new r,
        be = (_e = function (e) {
            for (var t, n, r, o, i, a, s, c, u = function (e, t) {
                ...
                return t
            }, l = new Array(80), f = 1732584193, d = 4023233417, h = 2562383102, m = 271733878, v = 3285377520, g = (e = unescape(encodeURIComponent(e))).length, y = [], _ = 0; _ < g - 3; _ += 4) n = e.charCodeAt(_) << 24 | e.charCodeAt(_ + 1) << 16 | e.charCodeAt(_ + 2) << 8 | e.charCodeAt(_ + 3),
                y.push(n);
            switch (g % 4) {
                case 0:
                    _ = 2147483648;
            ...
            for (y.push(_); y.length % 16 != 14;) y.push(0);
            for (y.push(g >>> 29), y.push(g << 3 & 4294967295), t = 0; t < y.length; t += 16) {
                for (_ = 0; _ < 16; _++) l[_] = y[t + _];
                for (_ = 16; _ <= 79; _++) l[_] = u(l[_ - 3] ^ l[_ - 8] ^ l[_ - 14] ^ l[_ - 16], 1);
                for (r = f, o = d, i = h, a = m, s = v, _ = 0; _ <= 19; _++) c = u(r, 5) + (o & i | ~o & a) + s + l[_] + 1518500249 & 4294967295,
                    s = a,
                    a = i,
                    i = u(o, 30),
                    o = r,
                    r = c;
                for (_ = 20; _ <= 39; _++) c = u(r, 5) + (o ^ i ^ a) + s + l[_] + 1859775393 & 4294967295,
                    s = a,
                    a = i,
                    i = u(o, 30),
                    o = r,
                    r = c;
                for (_ = 40; _ <= 59; _++) c = u(r, 5) + (o & i | o & a | i & a) + s + l[_] + 2400959708 & 4294967295,
                    s = a,
                    a = i,
                    i = u(o, 30),
                    o = r,
                    r = c;
                for (_ = 60; _ <= 79; _++) c = u(r, 5) + (o ^ i ^ a) + s + l[_] + 3395469782 & 4294967295,
                    s = a,
                    a = i,
                    i = u(o, 30),
                    o = r,
        ...
        }, we = Object.create(null), function (e) {
    ...
    Ae.prototype.use = function (e) {
        return c(e) && -1 === this.plugins.indexOf(e) && (e.call(this), this.plugins.push(e)),
            this
    };
    var Pe = Ae;
    ...
    Ue.prototype.combine = function (e) {
        ...
        return (e = void 0 === e ? [] : e).forEach(function (e) {
            var n, r, e = e.combine(),
                t = e.name,
                e = e.value,
                o = (n = t, r = -1, i.some(function (e, t) {
                    return !!le(e, n) && (r = t, !0)
                }), r);
            if (-1 === o) return i.push(t),
                void (a[i.length - 1] = [e]);
            a[o].push(e)
        }), {
            names: i,
    ...
    function y(t) {
        var n;
        if (!u(t)) return Be.document.cookie.split(We).some(function (e) {
            e = e.match(Je);
            return !(!e || ze.get.name(e[1]) !== t) && (n = ze.get.value(e[2]), !0)
        }),
            n
    }
    ...
    function Ke(e, t, n) {
        ...
        u(e) || v(t) || ((n = d({
            ...
            if (J(e = W(e) ? new Date((new Date).getTime() + 1e3 * e) : e)) return e.toUTCString()
        }(n.expires), r = "", f(n, function (e, t) {
            e && (r += We + t, !0 !== e && (e = e.split(";")[0], r += He + e))
        }), e = ze.set.name(e), t = ze.set.value(t), Be.document.cookie = e + He + t + r)
    }
    var _ = window,
        w = document,
    ...
    function vt(e) {
        ...
        return t.forEach(function (e) {
            var t;
            e && (t = (e = e.split(lt))[0], e = e.slice(1).join(lt) || "", t && (t = mt(t), e = mt(e), z(n, t) ? (a(n[t]) || (n[t] = [n[t]]), n[t].push(e)) : n[t] = e))
        }),
            n
    }
    ...
    function gt(e) {
        ...
        return f(e, function (e, t) {
            v(e) || (a(e) || (e = [e]), t = ht(t), e.forEach(function (e) {
                n.push("" + t + lt + ht(e))
            }))
        }),
            n.join(pt)
    ...
    function jt(e, t, n) {
        var r = ft.location.href,
            r = (g(e) && (n = t, t = e, e = r), v(e) && (e = r), n = d({
                replace: !0
            }, n), new Ct(e));
        return n.replace ? r.query = d(r.query || {}, t) : (e = gt(t)) && (n = -1 === r.search.indexOf(ut) ? ut : pt, r.search += n + e),
            r.toString()
    }
    ...
    function Dt(e) {
        var t, n, r, o = this.constructor,
            e = xt.call(this, e) || this;
        return Object.defineProperty(e, "name", {
            ...
            r = e,
            o = o.prototype, (t = Object.setPrototypeOf) ? t(r, o) : r.__proto__ = o,
            t = e,
            void 0 === n && (n = t.constructor), (r = Error.captureStackTrace) && r(t, n),
            e
    }
    It = function (e, t) {
    ...
    It(Nt, o),
        Nt.prototype = null === o ? Object.create(o) : (Rt.prototype = o.prototype, new Rt);
    e(Ut, qt = Dt),
    ...
    function E() {
        var e = arguments[0];
        e instanceof Mt && (arguments[0] = e.toString(), e = d(!0, {}, e.toJSON(), {
            message: e.toString()
    ...
    ln.prototype.use = function (e) {
        return -1 < this._installedPlugins.indexOf(e) || !c(e) || (e.call(this), this._installedPlugins.push(e)),
            this
    };
    n = ln;
    ...
    function vn(e) {
        ...
        var n, t = e;
        return (g(e) || a(e)) && (n = [], f(e, function (e, t) {
            v(e) || (a(e) ? t += "[]" : e = [e], f(e, function (e) {
    ...
    function bn(t, n) {
        if (4 === t.readyState) {
            var e, r, o = n.responseType,
                i = n.url,
                a = n.success,
                s = n.error,
                c = (e = t.status, c = (c = {
                    url: i
                }).url, 0 === e && 0 === c.indexOf("file:") ? 200 : {
                    1223: 204
                }[e] || e);
            if (0 !== c)
                if (sn(c)) {
                    try {
                        r = function (e, t) {
                            var n = t.responseType,
                                t = t.status,
                                r = e.response;
                            if (n === _n && e.responseType !== _n && !g(r)) try {
    ...
    function En(e) {
        ...
        wn(e.configured, {
            ...
            var t, n, r, o, i, a = e.request,
                s = ((e = e.options).method = e.method.toUpperCase(), a.open(e.method, (s = e.url, c = (u = e).method, t = e.cache, u = e.data, c === yn && (s = gn(s, u), t || (s = gn(s, {
                    _: Date.now()
                }))), s), !0), c = a, W(u = (u = e).timeout) && (c.timeout = u), t = a, e.withCredentials && (t.withCredentials = !0), a),
                c = e;
            if (c = c.responseType) try {
                s.responseType = c
            } catch (e) { }
            var u, p = a,
                l = (u = e).headers,
                ...
                d = u.data;
            if (g(l))
                for (var h in l) !l.hasOwnProperty(h) || v(l[h]) || "content-type" === h.toLowerCase() && (f === yn || G(d)) || p.setRequestHeader(h, l[h]);
            r = e, (n = a).onreadystatechange = function () {
                bn(n, r)
            },
                o = r.url,
                i = r.error,
    ...
    (function (e, t) {
        ...
        An.prototype.request = function (e, t) {
            ...
            return new Promise(function (e, t) {
                var r, o;
                s(i.url) && i.url ? (r = i, o = n, f(kn, function (n) {
                    r[n] = function (e, t) {
                        o.hooks.invokeWaterfall(n, e, t)
                    }
                }), i.success = e, i.error = t, En(i)) : t({
    ...
    (function (e, t) {
        ...
        Cn.prototype.request = function (e, t) {
            ...
            return function (e) {
                if (s(e) && e) return (e = In(e)) && 3 === e.split("/").length
            }(e) ? (o = t.url, i = t.data, new Promise(function (n, r) {
                v(S.KDJSBridge2) ? r(an("Jsbridge Undefined", o, -3, 1)) : S.KDJSBridge2.call("WDJSBridge", "thorRequest", {
                    ...
                    0 === t.code ? n(e) : (e = t.message, 10001 === t.code || -1 !== e.indexOf("暂未实现") || -1 !== e.indexOf("not implemented") ? r(an("Jsbridge Method Not Implement Error", o, -3, 2)) : r(an(t.message || "Jsbridge Method Call Error", o, -3, 3)))
                })
            }).then(function (e) {
    ...
    function Un() {
        ...
        function r() {
            var t;
            2 === ++e && (Nn = !0, t = Dn, f(qn, function (e) {
                e(t)
            }), qn.length = 0)
        }
        Rn || (Rn = !0, e = 0, t = function (e) {
            e && (Dn.suid = e),
                r()
    ...
    function Vn(e) {
        var t, e = new Ct(e),
            n = e.hostname,
            r = Hn();
        return /^thor\./gi.test(n) && Wn(r, "thor") && ((t = e).hostname = Jn(t.hostname), e = t), /^vimg\./gi.test(n) && Wn(r, "vimg") && ((t = e).hostname = Jn(t.hostname).replace(/^vimg\./gi, ""), t.pathname = "vimg" + t.pathname, e = t),
            e.href
    }
    var Fn = "wdtoken";
    ...
    function Qn(e, t) {
        return Promise.reject((t = t, H(e = e) ? (n = e.code, r = e.subcode, o = e.message, i = e.stack, {
            status: {
                code: v(n) ? -1 : n,
                subcode: r,
                message: o
            ...
            url: e.url,
            stack: i
        }) : (i = an("Thor code is not equal zero", t, -4).stack, (e = e || {}).url = t, e.stack = i, e)));
        var n, r, o, i
    }
    ...
    function zn() {
        if ($t.test(en)) {
            var e = document.querySelectorAll('meta[name="viewport"]'),
                e = e[e.length - 1];
            if (e) return (e = (e = e.getAttribute("content")) && e.match(/initial\-scale=([\d\.]+)/)) ? 1 / Number(e[1]) : 1
        }
        return 1
    }
    var Kn = 20,
    ...
    function Xn(e) {
        var t, n;
        if (g(e)) {
            var r = g(e.status) ? e.status : {}, e = g(e.result) ? e.result : {}, o = e.authPageUrl;
            if (r.code == Kn && o) return o = jt(o, ((r = {})[Yn] = S.location.href, r)),
                e.message && (r = e.message, e = zn(), r = '<div class="hawk-toast">' + r + '</div><style type="text/css">.hawk-toast{position:fixed;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);z-index:10000;width:50%;color:#fff;background:rgba(33,33,33,0.9);line-height:1.5;border-radius:' + 8 * e + "px;max-width:" + 300 * e + "px;padding:" + 20 * e + "px;font-size:" + 16 * e + "px;}</style>", (n = zt.body) && ((t = zt.createElement("div")).innerHTML = r, n.appendChild(t), setTimeout(function () {
                    n.removeChild(t)
                }, 1500))),
    ...
    function tr(e, t, n) {
        try {
            var r;
            if (4 == t.readyState)
                if (sn(t.status)) return r = g(t.response) ? t.response : function (e, t) {
                    try {
    ...
    function or(a) {
        f(rr, function (e) {
            ...
            t && (nr[e] = function (e) {
                ...
                }(e)) && (i = o.definition, o.namespace[o.name] = function (e) {
                    var t = arguments,
                        n = a,
                        r = function () {
        ...
        "function" == typeof (e = ir) && -1 !== e.toString().indexOf("[native code]") && (S.fetch = function () {
            return ir.apply(this, arguments).then(function (o) {
                return new Promise(function (e) {
                    ...
                    try {
                        if (sn(n.status)) return void n.clone().json().then(function (e) {
                            t.beforeSuccess(e, r)
                        }).
                            catch(function () {
                                r()
    ...
    function sr(e) {
        var i;
        g(e) && c(e.beforeSuccess) && (i = e, c(er) && (Zn.send = function () {
            var e = arguments,
                t = this,
                n = t.onreadystatechange,
                r = t.onload,
                o = !1;
            return n && (o = !0, t.onreadystatechange = function () {
                var e = arguments;
                tr(i, t, function () {
                    n.apply(t, e)
                })
    ...
    function ur(e) {
        return Promise.reject((n = (t = e).code, r = e.subcode, o = e.message, i = e.url, t = e.stack, {
            status: {
                code: v(n) ? -3 : n,
                subcode: r,
                message: o
    ...
    o.use(function () {
        ...
        o.use(function () {
            var e = this,
                n = (e.hooks.unshift("configured", function (e, t) {
                    ...
                    e.url = Vn(e.url),
                        e.responseType = "json",
                        e.data = e.data || {},
                        n = e.data, (r = y(Fn)) && (g(n) ? n[Fn] = r : G(n) ? n.append(Fn, r) : Q(n) && n.set(Fn, r)),
                        e.extra.deviceId ? (o = e.data, i = function () {
                            t()
                        }, Bn(function (e) {
            ...
            e.request = function () {
                var t = arguments[0];
                return n.apply(e, arguments).then(Gn).
                    catch(function (e) {
                        return Qn(e, t)
                    })
            }
    ...
    function mr(e) {
        try {
            ...
            var t = r.join("&");
            if (t) return new Blob([t], {
                type: "application/x-www-form-urlencoded; charset=UTF-8"
            })
        } catch (e) { }
        var n, r
    }
    var vr, gr = /(Android)\s+([\d.]+)/i,
        yr = /QQ\/([\d.]+)/i,
        _r = /micromessenger/i,
        wr = /wxwork\/.* MicroMessenger/i,
        br = /WDAPP\(WDBuyer/i,
        Er = /WDAPP\(WD\//i,
        Sr = /WDAPP\((?:wdbuyer|wd)\/([\d.]+)/i,
        kr = /miniProgram/i,
        Tr = navigator.userAgent.toLowerCase();
    ...
    function Ur() {
        var e = Jt(),
            t = "";
        return e < 2 ? t = Wt[1] + "." : 2 == e && (t = Wt[2] + "."), "https://logtake." + t + "weidian.com/h5collector/webcollect/3.0"
    }
    ...
    function zr(e, n) {
        return e.forEach(function (e) {
            var t;
            e.combine && ((t = me(e.combine().name.extend)).scene || (t.scene = n), e.combine().name.extend = h(t))
        }),
            e
    }
    var Kr = "https://assets.geilicdn.com/v-components/cdn/jweixin/1.6.0/index.fix.min.js",
        Yr = "gh_c6feb778444d",
        $r = ((n = {})[Yr] = ["weidian.com", "koudai.com", "v5.cc", "rua.fun"], n),
        Xr = {
            mpid: Yr,
    ...
    function Zr(o) {
        return new Promise(function (e, t) {
            ...
            s(o) ? (r = Oe("LOAD_SCRIPT_" + o, function () {
                return new de
            }), n = r.value, r = r.cached, n.push({
                resolve: e,
                reject: t
            }), r || (e = w.head, (r = w.createElement("script")).addEventListener("load", function () {
                n.resolve()
            }), r.addEventListener("error", function (e) {
                return n.reject(e.message)
            }), r.crossOrigin = "anonymous", r.src = o, e.appendChild(r))) : t()
        })
    }
    ...
    function Io(e, t) {
        return (t && t.whiteDomains.length ? Ao(function (e) {
            var e = d({
                ...
                t = e.whiteDomains || []; {
                var n;
                return e.append ? (n = _o, t.forEach(function (e) {
                    n.push(e)
                }), n) : t
            }
        }(t)) : Oo).test(e)
    ...
    function xo(e, t) {
        ...
        e = e.replace(/&#x([\dabcdef]+);?/gi, function (e, t) {
            ...
            yo.href = e;
        var n, e = yo;
        return n = e.protocol, !wo.test(n) && Io(e.hostname, t)
    }
        ...
        var t, n, r = function (e) {
            switch (e.nodeName) {
                ...
                case "A":
                    return e.href;
                case "PARAM":
                    if (-1 !== bo.indexOf(e.name)) return e.value
            }
            return e.src
        }(e);
        !r || (t = r, (n = e)[Eo] && n[Eo][t]) || (xo(r) ? (n = r, (t = e)[Eo] = t[Eo] || {}, t[Eo][n] = !0) : (r = e).parentNode && r.parentNode.removeChild(r))
    }
    var Lo = {
        A: Co,
        IMG: Co,
    ...
    t = function () {
        try {
            var e;
            To("observeIframe") && (e = vo.document.referrer || "", vo.self == vo.top || xo(e) || (vo.top.location.href = vo.location.href))
        } catch (e) { }
    },
    ...
    var Uo, Bo, Wo = _.history,
        Ho = Wo.pushState,
        Jo = Wo.replaceState,
        o = _.history.pushState ? "popstate" : "hashchange",
        Vo = new de({
            stateful: !1
        });
    ...
    function li(e, t) {
        if (ii(e))
            ...
            for (var o in e) pi(e, o) && t.call(null, e[o], o, e)
    }

    function fi(e) {
        for (var n, r, t = [], o = 1; o < arguments.length; o++) t[o - 1] = arguments[o];
        return r = ni("Boolean")(e) ? (n = e, t.shift()) : e,
            li(t, function (e) {
                li(e, function (e, t) {
                    n && (ii(e) || P(e)) ? (ii(e) ? ii(r[t]) || (r[t] = []) : P(r[t]) || (r[t] = {}), fi(n, r[t], e)) : r[t] = e
                })
            }),
            r
    }
    ...
    Ei.prototype.use = function (e) {
        return -1 < this._installedPlugins.indexOf(e) || !ai(e) || (e.call(this), this._installedPlugins.push(e)),
            this
    };
    t = Ei;
    ...
    function Pi(e) {
        if (ui(e)) return e.toString();
        var n, t = e;
        return (P(e) || ii(e)) && (n = [], li(e, function (e, t) {
            ei(e) || (ii(e) ? t += "[]" : e = [e], li(e, function (e) {
                ...
                try {
                    a = function (e, t) {
                        var n = t.responseType,
                            t = t.status,
                            r = e.response;
                        if (n === xi && e.responseType !== xi && !P(r)) try {
                            r = JSON.parse(e.responseText)
                        } catch (e) {
                            throw e
                        }
    ...
    function ji(e) {
        ...
        Ci(e.configured, {
            ...
            var t, n = e.request,
                r = e.options,
                o = (r.method = r.method.toUpperCase(), n.open(r.method, (e = r.url, t = (o = r).method, i = r.cache, o = r.data, t === Ii && (e = Ai(e, o), i || (e = Ai(e, {
                    _: Date.now()
                }))), e), !0), n.onreadystatechange = function () {
                    Li(n, r)
                }, t = n, r.withCredentials && (t.withCredentials = !0), n),
                i = r;
            if (i = i.responseType) try {
                o.responseType = i
            } catch (e) { }
            var a = n,
                s = (e = r).headers,
                ...
                u = e.data;
            if (P(s))
                for (var p in s) !s.hasOwnProperty(p) || ei(s[p]) || "content-type" === p.toLowerCase() && (c === Ii || ci(u)) || a.setRequestHeader(p, s[p]);
            Ci(r.beforeRequest, {
                request: n,
                options: r
            }, l)
    ...
    (function (e, t) {
        ...
        qi.prototype.request = function (e, t) {
            ...
            return new Promise(function (e, t) {
                var r, o;
                ri(i.url) && i.url ? (r = i, o = n, li(Ni, function (n) {
                    r[n] = function (e, t) {
                        o.hooks.invokeWaterfall(n, e, t)
                    }
                }), i.success = e, i.error = t, ji(i)) : t({
    ...
    function Fi(e) {
        ...
        return t.forEach(function (e) {
            var t;
            e && (t = (e = e.split(Bi))[0], e = e.slice(1).join(Bi) || "", t && (t = Vi(t), e = Vi(e), pi(n, t) ? (ii(n[t]) || (n[t] = [n[t]]), n[t].push(e)) : n[t] = e))
        }),
            n
    }
    ...
    function Gi(e) {
        ...
        return li(e, function (e, t) {
            ei(e) || (ii(e) || (e = [e]), t = Ji(t), e.forEach(function (e) {
                n.push("" + t + Bi + Ji(e))
            }))
        }),
            n.join(Ui)
    ...
    (function (e, t) {
        ...
        ca.prototype.request = function (e, t) {
            ...
            return function (e) {
                if (ri(e) && e) return (e = aa(e)) && 3 === e.split("/").length
            }(e) ? (o = t.url, i = t.data, new Promise(function (n, r) {
                ei(O.KDJSBridge2) ? r(gi("Jsbridge Undefined", -3, 1)) : O.KDJSBridge2.call("WDJSBridge", "thorRequest", {
                    ...
                    var t = (null == (t = null == e ? void 0 : e.param) ? void 0 : t._errMsg) || {};
                    0 === t.code ? n(e) : (e = t.message, 10001 === t.code || -1 !== e.indexOf("暂未实现") || -1 !== e.indexOf("not implemented") ? r(gi("Jsbridge Method Not Implement Error", -3, 2)) : r(gi(t.message || "Jsbridge Method Call Error", -3, 3)))
                })
            }).then(function (e) {
                return e.param.thorResponse
    ...
    function Sa() {
        ...
        function r() {
            var t;
            2 === ++e && (wa = !0, t = _a, li(Ea, function (e) {
                e(t)
            }), Ea.length = 0)
        }
        ba || (ba = !0, e = 0, t = function (e) {
            e && (_a.suid = e),
                r()
    ...
    function Oa(e) {
        var t = function (t) {
            var n;
            if (!ti(t)) return la.document.cookie.split(fa).some(function (e) {
                e = e.match(da);
                return !(!e || ya.get.name(e[1]) !== t) && (n = ya.get.value(e[2]), !0)
            }),
                n
        }(Ta);
    ...
    function Aa(e) {
        return Promise.reject((n = (t = e).code, r = e.subcode, t = e.message, {
            status: {
                code: ei(n) ? -1 : n,
                subcode: r,
                message: t
    ...
    function ja(e) {
        var t, n, r, o, i;
        if (P(e)) {
            var a = P(e.status) ? e.status : {}, e = P(e.result) ? e.result : {}, s = e.authPageUrl;
            if (a.code == xa && s) return a = s, (r = {})[Ca] = O.location.href,
                r = r,
                i = Wi.location.href,
                P(a) && (o = r, r = a, a = i),
                ei(a) && (a = i),
                ...
                i = new oa(a),
                o.replace ? i.query = fi(i.query || {}, r) : (a = Gi(r)) && (o = -1 === i.search.indexOf(Mi) ? Mi : Ui, i.search += o + a),
                s = i.toString(),
                e.message && (r = e.message, o = Ia(), r = '<div class="hawk-toast">' + r + '</div><style type="text/css">.hawk-toast{position:fixed;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);z-index:10000;width:50%;color:#fff;background:rgba(33,33,33,0.9);line-height:1.5;border-radius:' + 8 * o + "px;max-width:" + 300 * o + "px;padding:" + 20 * o + "px;font-size:" + 16 * o + "px;}</style>", (n = zo.body) && ((t = zo.createElement("div")).innerHTML = r, n.appendChild(t), setTimeout(function () {
                    n.removeChild(t)
                }, 1500))),
                void setTimeout(function () {
                    var e;
    ...
    function Ra(e, t, n) {
        try {
            var r;
            if (4 == t.readyState)
                if (yi(t.status)) return r = P(t.response) ? t.response : function (e) {
                    try {
                        return JSON.parse(e)
                    } catch (e) { }
                }(t.responseText),
        ...
        li(Ma, function (e) {
            ...
            t && (qa[e] = function (e) {
                ...
                return e && "SCRIPT" === e.tagName && e.src && ri(e = Fi(e = ei(e = e.src) ? Wi.location.href : e).callback) && (o = function (e) {
                    ...
                    t.apply(this, (e = arguments, Array.prototype.slice.call(e)))
            })
        })
    }
    var Ba = O.fetch;
        ...
        "function" == typeof (e = Ba) && -1 !== e.toString().indexOf("[native code]") && (O.fetch = function () {
            return Ba.apply(this, arguments).then(function (o) {
                return new Promise(function (e) {
                    ...
                    try {
                        if (yi(n.status)) return void n.clone().json().then(function (e) {
                            t.beforeSuccess(e, r)
                        }).
                            catch(function () {
                                r()
    ...
    function Ha(e) {
        var i;
        P(e) && ai(e.beforeSuccess) && (i = e, ai(Na) && (Da.send = function () {
            var e = arguments,
                t = this,
                n = t.onreadystatechange,
                r = t.onload,
            ...
            var e = this,
                t = (e.hooks.push("configured", function (e, t) {
                    ...
                    e.responseType = "json",
                        e.data = e.data || {},
                        Oa(e.data),
                        e.extra.deviceId ? (n = e.data, r = function () {
                            t()
                        }, ka(function (e) {
    ...
    function Qa() {
        ...
        return t = "https://thor".concat(t, ".weidian.com/skittles/share.getConfig/1.0"), (_i(e) ? Ga : Fa).request(t, e).then(function (e) {
            return e && e.result ? (e = e.result, Object.assign({}, e, {
    ...
    function za(e, t) {
        ...
        if (!e || !Ka.isUrl(e)) return e;
        var r = Xa(t);
        if (!t || !r) return e;
        var o = n[r];
        if (!o) return e;
        for (var i, a, s, t = (n = Ka.analyzeUrl(t)).protocol, n = n.host, c = e, u = -1, p = 0, l = o.length; p < l; p++) try {
            var f = o[p],
                d = f.status,
                h = f.pathRegExp,
                m = new RegExp(h);
        ...
        return -1 !== u && (i = (e = Ka.analyzeUrl(e)).pathname, a = e.search, s = e.host, e = e.hash, "privateRuleList" === r && "i.weidian.com" === s && (n = "".concat(n, "/user")), c = "".concat(t, "//").concat(n).concat(i).concat(a).concat(e)),
            c
    }
    var Ka = {
        ...
        var n, r, o, e = e.multidomainRuleMap,
            i = Ka.analyzeUrl(t),
            a = i.protocol,
            s = i.host,
            c = (i.origin, i.pathname),
            u = (i.search, i.hash, c.replace(/^\//, "").replace(/\/$/, "").split("/")),
            i = t;
        try {
            var p = e[s];
            if (p) {
                for (var l = [], f = 0, d = p.length; f < d; f++) {
                    var h, m, v, g = p[f],
                        ...
                        _ = g.backupPath,
                        w = g.pathRegExp;
                    1 == g.status && new RegExp(w).test(t) && y.length && (n = 0, r = y.length, o = void 0, o = Math.random(), h = y[n + parseInt(o * (r - n) + "")], m = "".concat(a, "//").concat(s, "/").concat(u[0], "/"), v = "".concat(a, "//").concat(h, "/").concat(u[0], "/"), _ && (v = "".concat(a, "//").concat(h, "/").concat(_, "/")), 0 === t.indexOf(m) && l.push(t.replace(m, v)))
                }
                var b = l.length;
                1 <= b && (i = l[b - 1])
            }
    ...
    var Za, es, ts, ns = function (e, t) {
        var n, r = "";
        return t && (n = t.mpConfigList, t = t.multidomainRuleMap, n && t && (e = $a(e, {
            multidomainRuleMap: t
        }), t = new oa(e).host, r = function (e, t) {
            var n = "";
    ...
    es = function () {
        ...
        w.body ? es() : (ts = !1, w.addEventListener("readystatechange", function () {
            !ts && w.body && (ts = !0, es())
        }));
    var rs, os = {}, is = 0;
    ...
    function ms(t) {
        ...
        if (r) return t(r);
        if (r = y(et), Br()) {
            if ((n = r) && 16 < n.length) return t(r);
            new Promise(function (t, n) {
                oo().then(function (e) {
                    e.call("WDJSBridge", "getCuid", {}, function (e) {
                        if (e && e.param && e.param.cuid) return t(e.param.cuid);
                        n("Get cuid error")
                    })
                }).
                    catch(function (e) {
        ...
        return v(gs) ? Ar() ? e((n = navigator.userAgent.match(/NetType\/(\S*)/i)) && n[1]) : Br() ? new Promise(function (t, n) {
            oo().then(function (e) {
                e.call("WDJSBridge", "getNetworkStatus", {}, function (e) {
                    if (e && e.param && e.param.network) return t(Ss[e.param.network]);
    ...
    function Os(n) {
        Ts(function (e) {
            if (!e) return n();
            var t = Es;
            t && le(t.get(), e) ? n(t) : (t = new Le(e), n(Es = t))
        })
    }
    e(As, Ps = Pe),
                ...
                if (e) {
                    ...
                    if ("spider" === t.type) {
                        ...
                        if (null != n) {
                            ...
                            switch (t.subtype) {
                                case "click":
                                    (-1 < r.indexOf("c") || "" === r) && (o[0] += "[click]:", o[1] = "color:#F6416C;");
                                    break;
                                case "page_view":
                                    (-1 < r.indexOf("p") || "" === r) && (o[0] += "[page_view]:", o[1] = "color:#1D6FA3;");
                                    break;
                                case "expose":
                                    (-1 < r.indexOf("e") || "" === r) && (o[0] += "[expose]:", o[1] = "color:#28C76F;");
                                    break;
                                default:
                                    return
                            }
    ...
    var Cs, Ls = {
        delay: 300
    }, js = (e(Ds, Cs = qe), Ds.prototype.push = function (e) {
        var t = this; - 1 === this.records.indexOf(e) && this.records.push(e),
        ...
        var e;
        this.records.length && (e = zr(this.records.slice(), "unload"), this.options.send.sendBeforeLeave({
    ...
    function Rs() {
        Ns().forEach(function (n) {
            qs(n).then(function () {
                var e, t;
                Mo(it, (e = Ns(), t = n, void (-1 !== (t = e.indexOf(t)) && e.splice(t, 1))))
            })
        })
    }
        ...
        return void 0 === o && (o = !0),
            new Promise(function (e) {
                ...
                o && !n && (Qo() ? (t = {
                    url: r.url,
                    data: r.data
                }, -1 === (n = Ns()).indexOf(t) && (n.push(t), Mo(it, n))) : qs(r).
                    catch(function () { })),
                    e()
            })
    }
    e(Ws, Us = Me),
            ...
            function s(e) {
                e.forEach(function (e) {
                    t = o.records,
                        ...
                        r = null,
                        t.some(function (e) {
                            return !!le(e.combine().value, n) && (r = e, !0)
                        });
                    var t, n, r, e = r;
                    e && a.push(e)
                })
        ...
        Ws.prototype.sendBeforeLeave = function (e, n) {
            var r = this,
                o = (void 0 === n && (n = !0), this.combine(e.records)),
    ...
    function ec(e, t) {
        ...
        return m.emit("exceptionHappened", {
            ...
            t.type = "log",
            g(r = (n = t).detail || {}) && (r.startTime = k(), f(r, function (e, t) {
                F(e) && (r[t] = h(e))
            }), n.detail = r),
    ...
    function oc(e) {
        var t, n, r;
        return H(e) ? (t = e.stack, n = e.message, e.cause, e.name, e.type, {
            message: n,
            stack: t,
            detail: r = U(e, ["stack", "message", "cause", "name", "type"])
        }) : F(e) ? (t = e.stack, n = e.message, r = U(e, ["stack", "message"]), t = "" + t, v(n) ? (n = h(e), r = void 0) : n = F(n) ? h(n) : $s(e.message), {
            message: n,
            stack: t,
            detail: r
        }) : {
    ...
    function lc(e, t) {
        ...
        var n, e = "function" == typeof e && null != e.cid ? e.options : e._isVue ? e.$options || e.constructor.options : e,
            r = e.name || e._componentTag,
            e = e.__file;
    ...
    function dc(e) {
        ...
        if (t && -1 !== Y(t, "3.0.0")) return "found in\n" + function (e) {
            if (!e) return [];
            var t = [];
            for (; e;) {
                var n = t[0],
            ...
            e = e.vnode;
            return "" + (0 === t ? "---> " : fc(" ", 5 + 2 * t)) + function (e, n, t) {
                void 0 === t && (t = !1);
                var r = c(n) && n.displayName || n.name,
                    o = "";
                !r && n.__file && (o = n.__file, (i = n.__file.match(/([^/\\]+)\.vue$/)) && (r = i[1])); {
                    var i;
        ...
        if (r._isVue && r.$parent) {
            for (var o = [], i = 0; r;) {
                if (0 < o.length) {
                    ...
                    0 < i && (o[o.length - 1] = [a, i], i = 0)
                }
                o.push(r),
                    r = r.$parent
            }
            return "found in\n" + o.map(function (e, t) {
                return "" + (0 === t ? "---> " : fc(" ", 5 + 2 * t)) + (Array.isArray(e) ? lc(e[0]) + "... (" + e[1] + " recursive calls)" : lc(e))
            }).join("\n")
        }
    ...
    function mc(r) {
        ...
        t = function (e) {
            ...
            _.Vue ? t(_.Vue) : (i = !1, Object.defineProperty(_, "Vue", {
                enumerable: !0,
                set: function (e) {
                    (n = e) && !i && (i = !0, t(n))
                },
        ...
        var t = function (e) {
            switch (e.nodeName) {
                ...
                case "OBJECT":
                    return e.data;
                case "PARAM":
                    if (-1 !== ct.indexOf(e.name)) return e.value;
                case "LINK":
                    return e.href
            }
            return e.src
        ...
        if (t && n) return {
            ...
            detail: {
                html: function (e) {
                    var t = e.outerHTML;
                    if (t) {
                        if (!(1 <= e.childNodes.length)) return t;
                        t = t.match(/^<[^>]+>/);
    ...
    function Pc(e) {
        var t, n, r = [],
            ...
            c = r.indexOf("sd");
        return t = o,
            n = e, -1 === s && (t !== n || 0 === parseFloat(t) || 0 === parseFloat(n)) || (t = o, n = e, 1 === s && (v(t) || v(n) || 0 === parseFloat(t) || 0 === parseFloat(n))) || (t = e, (n = o) && n === t && -1 === Sc.indexOf(n)) || (e = i, o = a, t = c, -1 !== (n = s) ? n < e || n < o || -1 !== t && t < n : -1 !== t ? -1 !== n && t < n || t < e || t < o : o < e)
    }
    ...
    function Nc(e) {
        var t, n = e.initiatorType,
            e = e.name;
        return "img" === n || (t = e, Dc.some(function (e) {
    ...
    function Uc(i) {
        function t(e) {
            ...
            return Nc({
                ...
                initiatorType: o,
                name: r
            }).initiatorType, n = n.name, "script" === t || -1 !== n.indexOf(".js") ? function (e, t) {
                Lc(this, e, t)
            }.call(i, r, e) : (n = (t = {
                initiatorType: o,
                name: r
            }).initiatorType, t = t.name, "link" === n && -1 !== t.indexOf(".css") ? function (e, t) {
                jc(this, e, t)
            }.call(i, r, e) : void 0))
        }
    ...
    function Qc(r, e) {
        ...
        g(a) && (o = Wr(a.url), t = c(e.resolve) ? e.resolve : l, i = c(e.reject) ? e.reject : l, Vc.forEach(function (n) {
            return r.addEventListener(n, function () {
                ...
                i(a, {
                    ...
                    }).message, e = e.type, (t = new Error(t)).type = e, t)
                })
            }, !1)
...
function $c(e, t) {
    var n, r = "error",
        o = "",
        i = t.error;
    if (n = e.url, new Ct(n).hostname !== Yc) return i && (r = i.type, o = i.message), {
        subtype: "requests",
        name: r,
        message: o,
        url: e.url,
...
function Xc(e, t) {
    var n, r = t.data,
        ...
        r = r.status_code,
        i = e.url;
    if (n = i, 0 !== (o || (void 0 === r ? 0 : r)) && Ys(n)) return {
        subtype: "requests",
        name: "non_zero_code",
...
function eu(e) {
    var t; {
        if (F(e) && !v(e.message)) return delete (t = d({}, e)).message,
            delete t.sample, {
            subtype: "custom",
            name: "error",
            url: T(),
...
function tu() {
    ...
    m.on("reportException", function (e) {
        var t = eu(e),
            e = e.sample;
        t && (void 0 === e || e ? as(Gs) && n.send(t) : (t.name = "error", t.detail.level = "error", n.send(t)))
    }),
        m.on("reportInformation", function (e) {
            var t = eu(e),
                e = e.sample;
            t && (void 0 === e || e ? as(Gs) && n.send(t) : (t.name = "info", t.detail.level = "info", n.send(t)))
        }),
        m.on("reportWarn", function (e) {
            var t = eu(e),
                e = e.sample;
            t && (void 0 === e || e ? as(Gs) && n.send(t) : (t.name = "warn", t.detail.level = "warn", n.send(t)))
        })
}

function nu(e) {
    if (c(e.toJSON)) return e.toJSON();
    try {
        var t, n = {};
...
function iu(e) {
    return 5 * e.querySelectorAll("img").length + e.querySelectorAll("*").length + .5 * (n = "", p(e.children).forEach(function (e) {
        var t = e.tagName;
...
function _u() {
    n = .45,
        yu.some(function (e) {
            var t = e.regexp,
                e = e.rate;
            return !!t.test(location.href) && (n = e, !0)
        });
    var n, e = n;
    return Math.random() < e
}
...
function Su(e, t) {
    ...
    var n = lu(),
        ...
        n = (v(o) ? o = {
            c: 1,
            h: n
        } : (e.caches.splice(t, 1), o.c = ++o.c), Eu = o.c, e.caches.unshift(o), e.timestamp = r, e);
    try {
        if (v(n)) return void localStorage.removeItem(fu);
        localStorage.setItem(fu, h(n))
    } catch (e) { }
}

function ku() {
    return 0 === Jt() || (s(b()[hu]) || (v(bu) && (n = -1, t = 0, v(e = function () {
        var e;
        try {
            e = me(localStorage.getItem(fu) || "")
        } catch (e) { }
        if (g(e) && a(e.caches)) return e.caches.splice(gu),
            e
    }()) || (r = e.caches, o = lu(), i = -1, a(r) && r.some(function (e, t) {
        return e.h === o && (i = t, !0)
    }), n = i, (r = e.caches[n]) && (t = r.c)), Su(e, n), bu = wu(t + 1)), bu));
    var e, t, n, r, o, i
}
var I = new r,
    Tu = {
...
function ju(e, t) {
    var n;
    return t.type = "perf_ext1", (n = t).detail = h(Pu(n.detail)),
        Cu.call(this, e, t) || this
}
var Du, Nu = {
    delay: 300
}, Ru = (e(qu, Du = qe), qu.prototype.push = function (e) {
    var t = this; - 1 === this.records.indexOf(e) && this.records.push(e),
    ...
    this.records.length && (this.options.send.send({
        ...
        catch(function () { }), this.records.length = 0)
}, qu);
...
function Yu(t, e) {
    ...
    function r(e) {
        var t, n;
        e.hadRecentInput || (t = s[0], n = s[s.length - 1], a && e.startTime - n.startTime < 1e3 && e.startTime - t.startTime < 5e3 ? (a += e.value, s.push(e)) : (a = e.value, s = [e]), a > i.value && (i.value = a, i.entries = s, o()))
    }
    fp || (lp(function (e) {
        dp = e.value
    }), fp = !0);
...
function $u(e, t) {
    ep || (ep = t, tp = e, np = new Date, yp(removeEventListener), vp())
}

function Xu(e, t) {
    function n(e) {
        e.startTime < r.firstHiddenTime && (o.value = e.processingStart - e.startTime, o.entries.push(e), a(!0))
    }
    var r = pp(),
        o = op("FID"),
        i = ip("first-input", n),
...
function Zu(t, n) {
    function e(e) {
        var t = e.startTime;
        t < i.firstHiddenTime && (a.value = t, a.entries.push(e), r())
    }
    var r, o, i = pp(),
        a = op("LCP"),
        s = ip("largest-contentful-paint", e);
    s && (r = cp(t, a, n), o = function () {
        _p[a.id] || (s.takeRecords().map(e), s.disconnect(), _p[a.id] = !0, r(!0))
    }, ["keydown", "click"].forEach(function (e) {
        addEventListener(e, o, {
            once: !0,
            capture: !0
        })
    }), ap(o, !0), sp(function (e) {
        a = op("LCP"),
            r = cp(t, a, n),
...
var ep, tp, np, rp, op = function (e, t) {
    ...
    var o;
    return function (e) {
        0 <= n.value && (e || r) && (n.delta = n.value - (o || 0), !n.delta && void 0 !== o || (o = n.value, t(n)))
    }
}, up = -1,
    pp = function () {
        return up < 0 && (up = zu(), Ku(), sp(function () {
            setTimeout(function () {
                up = zu(),
                    Ku()
            }, 0)
        ...
        function e(e) {
            "first-contentful-paint" === e.name && (s && s.disconnect(), e.startTime < o.firstHiddenTime && (i.value = e.startTime, i.entries.push(e), r(!0)))
        }
        var r, o = pp(),
            i = op("FCP"),
            a = window.performance && performance.getEntriesByName && performance.getEntriesByName("first-contentful-paint")[0],
            s = a ? null : ip("paint", e);
        (a || s) && (r = cp(t, i, n), a && e(a), sp(function (e) {
            i = op("FCP"),
                r = cp(t, i, n),
                requestAnimationFrame(function () {
                    requestAnimationFrame(function () {
    ...
    vp = function () {
        ...
        e.cancelable && (t = (1e12 < e.timeStamp ? new Date : performance.now()) - e.timeStamp, "pointerdown" == e.type ? (n = t, r = e, o = function () {
            removeEventListener("pointerup", i, hp),
                removeEventListener("pointercancel", a, hp)
        }, addEventListener("pointerup", i, hp), addEventListener("pointercancel", a, hp)) : $u(t, e))
    }, yp = function (t) {
...
function Ep(i) {
    return new Promise(function (o) {
        setTimeout(function () {
            var t, e, n, r;
            o((t = i, e = _.performance.getEntriesByType("resource"), r = n = 0, e.some(function (e) {
                bp(e, t) && (r++, n += e.duration)
            }), r && n / r))
        }, 1200)
    })
}
...
function Pp(e) {
    var t, n = function (e) {
        for (var t, n = Sp && Sp.length, r = 0; r < n; r++) Sp[r].el === e && (t = Sp[r]);
        return t
    }(e);
    return v(n) ? (t = function (e) {
        if (0 === (e = e.getBoundingClientRect()).width && 0 === e.height) return !1;
        var t = e.top + 5,
            n = e.bottom - 5,
            r = e.left + 5,
            e = e.right - 5;
...
function xp(o) {
    return new Promise(function (r) {
        setTimeout(function () {
            var t, e, n;
            r((t = o, e = _.performance.getEntriesByType("resource"), n = 0, e.some(function (e) {
                e.startTime < t + 1e3 && n++
            }), t + 4 * n))
        }, 1200)
    })
...
function Lp() {
    return new Promise(function (n) {
        Yu(function (e) {
            var t;
            W(e.value) && (t = !a(e.entries) || null == (t = e.entries[0]) ? void 0 : t.startTime, n((e = e.value, t = null != t ? t : k(), {
                entryType: Au,
    ...
    return new Promise(function (t) {
        ...
        du && (n = function (e, t) {
            ...
            var e = function () {
                ...
                if (e.length) return (e = nu(e[0])).visit = Eu,
                    e
            }();
            e && (n.disconnect(), t(e))
        }))
...
function Hp(r) {
    ...
    var o, e = function (e) {
        ...
        var t, n = Wp(e);
        n = n, (t = o) && n && (5 < Math.abs(n.x - t.x) || 5 < Math.abs(n.y - t.y)) && r(e),
            o = void 0
    };
...
function Jp(e) {
    ...
    }, o = (n = e, w.addEventListener(Rp, n, !0), function () {
...
function zp(n) {
    po(function () {
        var e = _s(),
            t = ws();
        e && t && (Qp(e, t), n(), I.emit("PAGE_ENTER", {
            type: "PAGE_ENTER",
            startTime: k(),
            spma: e,
            spmb: t,
...
function Xp(t) {
    ...
    I.on("PAGE_ENTER", function (e) {
        ...
        I.on("PAGE_HIDE", function (e) {
            n && r && (n.duration += e.startTime - r.startTime, r = e)
        }),
        zp(function () {
            $p(),
                mo(function () {
                ...
                Go(function () {
                    ke(function () {
                        var e, t = _s(),
                            n = ws();
                        t && n && (t !== Gp.spma || n !== Gp.spmb) && (e = k(), I.emit("PAGE_LEAVE", {
                            type: "PAGE_LEAVE",
                            startTime: e,
                            reason: "SPMAB_CHANGE"
                        }), I.emit("PAGE_ENTER", {
...
function nl() {
    ...
    m.on("reportPerformanceTiming", function (e) {
        e = function (e) {
            ...
            if (F(e) && !v(e.name) && W(n)) return delete (t = d({}, e)).name,
                delete t.value,
                delete t.startTime,
                delete t.duration, {
...
var rl, ol = "#ui-share-box",
    ...
    cl = "vbuyer",
    ul = "kdweidian",
    pl = (e(ll, rl = Mt), ll.prototype.toJSON = function () {
...
var hl = fl(function () {
    var e, t = b()[il],
        t = t && dl(t),
        n = y("duid") || y("uid") || y("WD_b_id") || "",
        t = t ? (e = t.share_id, parseInt(t.share_level || "0", 10) + 1) : (e = Nr(), 1);
    return [e, n, t].join("_")
});

function ml(e, t) {
    var n = b().wfr;
    return n ? (a(n) && (n = n[n.length - 1]), Object.getOwnPropertyNames(al).forEach(function (e) {
        n = n.replace("_" + al[e], "")
    })) : n = "h5direct",
        jt(e, {
            wfr: n += "_" + t
...
function gl(e) {
    var t;
    return e = e, (t = document.createElement("a")).href = e,
...
function wl() {
    for (var e = Array.prototype.slice.call(document.querySelectorAll(".J_closed")), t = document.querySelector(ol), n = 0; n < e.length; n++) e[n].addEventListener("click", function () {
    ...
    Al = {
        ...
        panel: {
            ...
            validator: function (e, t) {
                if (!a(e)) return Promise.reject(new Error("panel field must be array"));
                if (e.some(function (e) {
                    return [1, 2, 3, 4, 104].indexOf(e) < 0
                })) return Promise.reject(new Error("invalid panel item!"));
                if (-1 < e.indexOf(2) && !t.posterUrl && !t.postList) return Promise.reject(new Error("panel field pass 2 value must contain posterUrl or postList field"));
                if (-1 < e.indexOf(3) && !t.text) return Promise.reject(new Error("panel field pass 3 value must contain text field"));
                if (-1 < e.indexOf(4) && -1 === e.indexOf(1) && -1 === e.indexOf(3)) return Promise.reject(new Error("password panel depends on link panel or text panel"));
                if (-1 < e.indexOf(104)) {
                    if (-1 === e.indexOf(1)) return Promise.reject(new Error("qrcode panel depends on link panel"));
...
function Il(i) {
    var r, o, e = Object.getOwnPropertyNames(Al),
        a = (r = i, o = {}, Object.getOwnPropertyNames(Al).forEach(function (t) {
            var n = Al[t],
        ...
        e = e.filter(function (e) {
            ...
            for (var t = a[e], e = i[e], n = (v(e) && (e = ""), t), t = e, r = (0, n[0])(t), o = 1; o < n.length; o++) r = r.then(n[o]);
            return r
        });
    return Promise.all(e)
}
...
var Cl, Ll = new r,
    jl = (e(Dl, Cl = xl), Dl.prototype.loadSdk = function (e) {
        this.sdkPromise && this.sdkPromise.
            catch(function () { }),
        ...
        return n === al.WECHAT_MOMENT && (delete e.desc, e.title = t.pyqTitle || t.title),
            e
        ...
        var t = [],
            ...
            n = e.indexOf("share"),
            n = (-1 < n && (t = t.concat(["menuItem:share:appMessage", "menuItem:share:timeline", "menuItem:share:qq", "menuItem:share:weiboApp", "menuItem:favorite", "menuItem:share:facebook", "menuItem:share:QZone"]), e.splice(n, 1)), e.indexOf("protect"));
        return -1 < n && (t = t.concat(["menuItem:editTag", "menuItem:delete", "menuItem:copyUrl", "menuItem:originPage", "menuItem:readMode", "menuItem:openWithQQBrowser", "menuItem:openWithSafari", "menuItem:share:email"]), e.splice(n, 1)),
            t.push.apply(t, e),
            t = Hr(t)
    }, Dl);
        ...
        return this.sdkPromise.then(function () {
            n.config = d(!0, {}, t),
                ...
                n.config.vsellerShare && _.KDJSBridge2.call("WDJSBridge", "share", {
                    ...
                    e = yl(n.config, e);
                    e.error ? (t.error && t.error(e), _.spider && _.spider.trackAction({
                        actionName: "shareFail",
                        actionArgs: {
                            app: ul,
                            shareUrl: t.url,
                    ...
                    })) : (t.success && t.success(e), _.spider && _.spider.trackAction({
                        actionName: "shareSuccess",
                        actionArgs: {
                            app: ul,
                            shareUrl: t.url
...
function Ul(o, i) {
    ...
    var t, e = [{
        ...
        e = (0 === s.length && r.push(e[0]), r.forEach(function (e) {
            var t, n, r;
            t = 1 === e.panelType ? (t = s.filter(function (e) {
                return 2 === e || 3 === e
            }).map(function (e) {
                return Number("10" + e)
            }), -1 < s.indexOf(104) && t.push(104), Hr(a.concat(t).filter(function (e) {
                return 7 != e
            })).join("_")) : a.filter(function (e) {
                return [18, 101, 102, 103, 104].indexOf(e) < 0
            }).join("_"),
                e.content.scene = t,
                2 === e.panelType && (e.content.postList = (t = [], (r = o).postList && r.postList.length ? r.postList.filter(function (e) {
                    return 9 !== e.postType
                }) : r.posterUrl ? [{
                    postType: 0,
                    desc: "纯图片海报",
                ...
                104 === e.panelType && (e.content.postList = (r = [], r = (n = o).postList && n.postList.length ? n.postList.filter(function (e) {
                    return 9 === e.postType
                }) : r)),
    ...
    return o.header && (e.headerInfo = o.header),
        o.panelStyle && (r = Cr(), e.panelStyle = o.panelStyle, r && Or() && -1 === Y(r, "6.1.4") && (t = 0, (r = (r = e.panelList).filter(function (e) {
...
e(Hl, Bl = xl),
    ...
    Hl.prototype.option = function (e) {
        ...
        return this.sdkPromise.then(function () {
            return t.config = d(!0, {}, e),
                t.config.vbuyerShare && (t.isRegisterConerShareCallback || t.registerShareCallback(t.config), t.setShareConfig(t.config)),
                Promise.resolve(e)
        })
    },
        ...
        this.sdkPromise.then(function () {
            ...
            Gt("evoke", JSON.stringify(n)),
                _.KDJSBridge2 && _.KDJSBridge2.call("WDJSBridge", "share", {
                    ...
                    var t = yl(n, e);
                    t.error ? (r.error && r.error(t), _.spider && _.spider.trackAction({
                        actionName: "shareFail",
                        actionArgs: {
                            app: cl,
                            scene: e && e.param && e.param.type || "unknow",
                    ...
                    })) : (t.scene = e.param.type, r.success && r.success(t), _.spider && _.spider.trackAction({
                        actionName: "shareSuccess",
                        actionArgs: {
                            app: cl,
                            scene: e && e.param && e.param.type || "unknow",
    ...
    Hl.prototype.registerShareCallback = function (n) {
        ...
        _.KDJSBridge2.FN_registerHandler("share", "nativeShareResult", function (e) {
            ...
            t.error ? n.error && n.error(t) : (t.scene = e && e.type, n.success && n.success(t)),
        ...
        Gt("newShareOption", JSON.stringify(r)),
            ...
            n = function (e) {
                e && e.param && e.param.exist ? _.KDJSBridge2.call("Share", "showOption", {
                    ...
                    e = yl(r, e);
                    e.error && (e.message = "webview 右上角唤起失败", t.error && t.error(e))
...
var Jl, Vl = ["qfriendh5", "qzoneh5", "wxh5", "wxph5"],
    Fl = (e(Gl, Jl = xl), Gl.prototype.loadSdk = function () {
...
var Yl = {
    ...
    this.optionPromise && this.optionPromise.
        catch(function () { }),
        this.optionPromise = Il(t.config).then(function () {
            return t.invokeHooks()
        }).
            catch(function (e) {
                return e ? (e.name = "[Pathtracker Error] ValidationError", Ll.emit("PATHTRACKER_EXCEPTION", e), Promise.reject(e)) : Promise.resolve()
            })
}, $l.prototype.evoke = function (e) {
    var t, n = this;
    if (!this.config || !this.optionPromise) return E(t = new pl({
    ...
    return !c(e) || -1 < this.installedPlugins.indexOf(e) || (e.call(this), this.installedPlugins.push(e)),
        this
}, $l.prototype.
    catch = function (t) {
        ...
        return new Promise(function (e, t) {
            n.hooks.invokeWaterfall("configured", n.config, function () {
                n.instance.option(n.config).then(e).
                    catch(t)
            })
        })
...
(function (e) {
    ...
    function l(e) {
        var t, n = [];
        for (t in e) "object" == typeof e[t] ? n.push(t + "=" + JSON.stringify(e[t])) : n.push(encodeURIComponent(t) + "=" + encodeURIComponent(e[t]));
        return n.join("&")
    }
    ...
    function c(e, t, n) {
        ...
        if (e && e.status) {
            ...
            r.status.code = o,
                ...
                r.result = e.result,
                s === w ? t && t(r) : n && n(r)
        } else n && n(new Error("interface isn't legal"))
    }
    ...
    function d(e) {
        var t, n = (e = e || {}).data || {}, r = e.jsonp || "callback",
            o = e.success,
            i = e.error,
            e = e.url;
        if (!e) return i && i(new Error("url is not defined!"));
        var a, s = "jsonp_" + y++,
            c = document.getElementsByTagName("head")[0],
            u = document.createElement("script"),
            p = (n[r] = s, a = !1, function () {
                a || (a = !0, t ? o && o(t) : i && i(new Error("callback function error!")))
            });
    ...
    v = window,
        ...
        t = {
            ...
            getUserInfo: function (e) {
                ...
                }) : (r.status.code = b, r.status.message = S, r.result = "", n && n(r))
            },
            qqLogin: function (e) {
                var t = a((e = e || {}).url, k),
                    n = o(e.environment),
            ...
            isOpenShop: function (e) {
                var t = (e = e || {}).success,
                    ...
                    r = s("sid");
                if (!r) return n && n(new Error("没获取到当前登录的卖家id"));
                d({
                    url: e,
                    data: {
                        context: {
            ...
            addShop: function (e) {
                ...
                if (!s("sid")) return n && n(new Error("没获取到当前登录的卖家id"));
                r = r || {
                    shopName: "我的小店",
...
function af(e, t) {
    ...
    n ? (n = {
        channel: e,
        pathInfo: dl(n)
    }, s = n.pathInfo, c = n.channel, new Promise(function (r, o) {
        Os(function (e) {
            var e = e && e.get(),
                t = e && e.spma,
                n = e && e.spmb;
        ...
        return t.send(e)
            ...
            channel: e
        }, a = dl(hl()), new Promise(function (r, o) {
            Os(function (e) {
                var e = e && e.get(),
                    t = e && e.spma,
                    n = e && e.spmb;
...
function uf() {
    this.hooks.push("configured", function (e, t) {
        ...
        e.success = function (e) {
            ...
            e.error = function (e) {
                "用户取消分享" === e.message ? Gt(JSON.stringify(e)) : (delete e.error, E(new pl(M(M({}, e), {
                    name: "CallbackError"
                })))),
                    c(r) && r(e)
            },
...
function pf() {
    ...
    this.hooks.push("configured", function (t, n) {
        ...
        !Pr() && Za ? Za.then(function (e) {
            Qr("pathtracker") && !Ya(T()) && (t.url = $a(r, e), e = ns(r, e), Ar() && o.instance.loadSdk({
                mpid: e
            })),
                n && n()
        }).
...
sf.use(function () {
    var e, t, n, r = this;
    if ((n = Ar() && !jr() && !rf.isLogin() && !Ir() && Vr().indexOf("silentlogin") < 0) && m.emit("pageNavigate"), n) return n = _.location.hash,
        t = b(), "" !== n && Or() ? (n = t.slr || "", t.slr = Nr(n, 4)) : t.slr && delete t.slr,
        n = _.location.href,
        e = (n = n.split("#"))[0],
        n = (n = n[1]) ? "#" + n : "",
...
var x, mf = "data-spider",
    vf = "data-spider-prior",
    gf = "data-spider-mode",
    yf = "data-spider-action-name",
    _f = "data-spider-action-args",
    wf = "data-spider-impression",
    bf = "spider_action",
    Ef = "spider_token",
    Sf = "spider_token_alias",
    kf = "javascript:",
    Tf = "undefined",
    Of = "time_on_page_spm",
    Pf = ((o = x = x || {}).BUY_NOW = "_buyNow", o.ADD_TO_CART = "_addToCart", o.ADD_TO_FAVORITES = "_addToFavorites", o.COLLECTION = "_collection", o.SHARE = "_share", o.LIKE = "_like", o.IM = "_im", o.ITEM = "_item", o.SHOP = "_shop", o.DYNAMIC = "_dynamic", o.DOWNLOAD = "_download", !!_.sessionStorage);
...
function If(e) {
    var t, n = e.actionName,
        e = e.actionArgs,
        r = Object.create(null);
    (t = {})[x.ITEM] = function (e) {
        e && e.itemId && e.shopId ? r.isOk = !0 : (r.isOk = !1, r.message = "pageArgs._page=_item时 pageArgs必须包含itemId和shopId属性")
    },
        t[x.SHOP] = function (e) {
            e && e.shopId ? r.isOk = !0 : (r.isOk = !1, r.message = "actionName=_shop或者pageArgs._page=_shop时 actionArgs或者pageArgs必须包含shopId属性")
        },
        t[x.DYNAMIC] = function (e) {
            e && e.authorId && e.feedId ? r.isOk = !0 : (r.isOk = !1, r.message = "actionName=_dynamic或者pageArgs._page=_dynamic时 actionArgs或者pageArgs必须包含authorId属性和feedId属性")
        },
        t[x.IM] = function (e) {
            r.isOk = !0
        },
        ...
        t[x.ADD_TO_FAVORITES] = function (e) {
            e && e.shopId ? 0 === (e = Af(e.type)) || 1 === e ? r.isOk = !0 : (r.isOk = !1, r.message = "actionName=_addToFavorites type属性必须传0(取消)或1(关注)") : (r.isOk = !1, r.message = "actionName=_addToFavorites actionArgs必须包含shopId和type属性")
        },
        t[x.BUY_NOW] = function (e) {
            r.isOk = !0
        },
        t[x.COLLECTION] = function (e) {
            e && e.itemId ? 0 === (e = Af(e.type)) || 1 === e ? r.isOk = !0 : (r.isOk = !1, r.message = "actionName=_collection type属性必须传0(取消)或1(关注)") : (r.isOk = !1, r.message = "actionName=_collection actionArgs必须包含itemId和type属性")
        },
        t[x.LIKE] = function (e) {
            var t = Af(e && e.type);
            !e || 0 !== t && 1 !== t ? (r.isOk = !1, r.message = "actionName=_like actionArgs必须包含type属性且必须传0(取消)或1(关注)") : r.isOk = !0
        },
    ...
    return n && t[n] && t[n](e),
        void 0 === r.isOk && (r.isOk = !1, r.message = "actionName " + n + "不是内置actionName"),
        r
}
xf = function (e, t) {
...
function Bf(e, t) {
    for (var n = e; ;) {
        if (n === w.body) return null;
        if (n === w.documentElement) return null;
        if (null === n) return null;
        if (n.nodeType === Node.DOCUMENT_FRAGMENT_NODE) return null;
        if (t(n)) return n;
        n = n.parentElement
    }
}
...
function Vf(e) {
    if (!Uf(e) || !Wf(e)) return null;
    var t, n = e.getAttribute(yf) || null,
        r = qf(e.getAttribute(_f)),
        o = Bf(e.parentElement, Hf),
        o = o ? (t = o.getAttribute(vf) || o.getAttribute(mf), String(function (e, t) {
            for (var n = e.querySelectorAll("[" + mf + "],[" + yf + "],[" + wf + "], a[href]"), r = 0, o = 0; o < n.length; o++)
                if (Wf(n[o]) && r++, t === n[o]) return r;
            return 0
        }(o, e) || "_")) : (t = "_", String(function (e) {
            for (var t = w.querySelectorAll("[" + yf + "], [" + wf + "]"), n = 0, r = 0; r < t.length; r++)
                if (null === Bf(t[r].parentElement, Hf) && n++, e === t[r]) return n;
            return 0
        }(e) || "_"));
    return "_" !== t || "" !== n && null !== n || !Nf(e) || (t = "spider-auto", o = String(function (e) {
        ...
        if (e.actionType && Qt(new C({
            ...
            if (Ff(n))
                if (o && !g(o)) E(new C({
                    ...
                    if (r && 0 === r.indexOf("_")) {
                        if (!Gf(r) && "_cancelToFavorites" !== r && "_deprecated" !== r && "_expose" !== r) return void E(new C({
                        ...
                        o = If(e);
                        if (r !== x.ITEM && !o.isOk) return E(new C({
                            message: o.message,
                            name: "InternalActionNameError"
                        })),
                            1
...
function td(e) {
    var t, n;
    g(e) && (void 0 === e.spmd && (e.spmd = "1"), e.spmc = String(e.spmc || "_"), e.spmd = String(e.spmd || "_"), t = String(e.actionName || ""), n = String(e.actionType || ""), e.actionName = t || n, e.actionArgs = e.actionArgs || null)
}
...
function ud() {
    if (c(_.performance.getEntriesByType)) {
        var e = _.performance.getEntriesByType("navigation");
        if (e.length) return (e = function (e) {
            if (c(e.toJSON)) return e.toJSON();
            try {
                var t, n = {};
                for (t in e) z(e, t) && (n[t] = e[t]);
    ...
    } else if (_.performance.navigation) return e = _.performance.navigation.type,
        cd[e];
    return null
}
var pd = {
...
function ld(e) {
    var t = Nr(JSON.stringify(e), 4),
        e = d(!0, {}, e),
        n = ((n = e).prev_page_args || (n.prev_page_args = {}), n.prev_action_args || (n.prev_action_args = {}), tt + "_" + t);
    return Mo(n, e),
        Ke(n, h(e), {
            domain: Mr(),
            path: "/",
...
function fd(e) {
    var t, n, e = tt + "_" + e,
        e = qo(e) || me(y(e) || "");
    return e || (t = Mf("spider"), n = Mf(bf) || null, e = t ? d(!0, {}, pd, {
        prev_spm: t,
        prev_action_name: n
    }) : null),
        f(Xf(), function (e, t) {
            var n;
            "string" == typeof t && 0 === t.indexOf(tt) && (t = t, n = {
                domain: Mr(),
                path: "/"
            }, Ke(t, "", d(n || {}, {
                expires: -864e5
...
var L = new r,
    ...
    yd = (_d.prototype.trackPageview = function (e) {
        ...
        n && t && n !== Tf && t !== Tf ? (e && !g(e) && (E(new C({
            ...
            name: "ValidationError"
        })), e = {}), this.setBase(n, t, e), t = (n = this.root.get()).prevData, e = n.curPageArgs, n = n.curSpm, L.emit("report_prev_data"), md && L.emit(vd), this.reportSpiderData(t, e, n)) : Qt("[spider 提示] meta & body 上必须包含 data-spider 值")
...
var wd = function () {
    ...
    n && Qt("[Spider Warn]方法 spider." + ("click" === t ? "trackAction" : "trackImpression") + "不再兼容支持传第二个参数回调监听callback\n详情参见文档：http://docsify.daily.vdian.net/spider/46/refactor-changes.html"),
        ...
        }), e = this.root.get().curSpm, this.root.report(t, wd({
            cur_spm: e,
            cur_page_args: o,
...
Td.prototype.transferActionBy = function (t, e, n) {
    ...
    return this.root.hooks.invokeWaterfall("beforeNavigate", i, function (e) {
        ...
        n ? (_.location.href = i.url, kf) : i.url
},
    Td.prototype.transferAction = function (e) {
        ...
        td(e),
            ...
            }), e = ld(this.generatePrevData(e)), this.root.setToken(e))
    },
    Td.prototype.handleSpiderToken = function (e) {
        ...
        var t = ld(this.generatePrevData(e.action)),
            t = (this.root.setToken(t), this.getSpiderTokenParams(e));
        e.url = jt(e.url, t)
    },
    ...
    Td.prototype.getSpiderTokenParams = function (e) {
        var t = Object.create(null),
            ...
            n = n.token,
            o = Rf(e.url);
        return Mr(o.hostname) === Mr() ? n && (t[Ef] = n) : (t[Sf] = n, t.spider = r, e.action.actionName && (t[bf] = e.action.actionName)),
            t
    };
var Sd, kd = Td;
...
function Ad(e, t) {
    ...
    return t.type = "spider",
        g(r = (n = t).detail || {}) && (r.startTime = k(), f(r, ed), n.detail = r), "page_view" !== n.subtype && "event" !== n.subtype && (g(r = n.cur_action_args) ? f(r, ed) : r = null, n.cur_action_args = r),
...
(function (e, t) {
    ...
    Ld.prototype.push = function (e) {
        var t;
        "event" === (null == e ? void 0 : e.data.subtype) ? ((t = []).push(e), this.reportOptions.send.sendBeforeLeave({
...
var Rd, qd, Md = function (e, t) {
    ...
    Rd(e, t),
        e.prototype = null === t ? Object.create(t) : (n.prototype = t.prototype, new n)
}(Ud, qd = Me), Ud.prototype.updateSpmaAndSpmb = function () {
    var e = Zf(),
        t = e.spma,
        e = e.spmb,
    ...
    var n, r, e = d(!0, {}, e),
        e = d(!0, {}, (n = e, r = Kf, Object.keys(n).reduce(function (e, t) {
            return !(!a(r) || -1 === r.indexOf(t)) || c(r) && r(t) ? e : Df(Df({}, e), ((e = {})[t] = n[t], e))
        }, {})), Yf());
    ...
    e.prev_spm ? (t && t._page && Gf(t._page) && ((n = If({
        ...
        message: n.message,
        name: "InternalActionNameError"
    })), n = t._page, t = Md(t, ["_page"]), e.prev_action_name = n, e.prev_action_args = d(!0, {}, t, e.prev_action_args)), e.prev_action_name || (e.prev_action_name = "_jumpTo_" + this.curSpmArray[0] + "." + this.curSpmArray[1]), this.prevData = e) : this.prevData = null
...
function Kd(i) {
    w.body.addEventListener("click", function (e) {
        ...
        if (null !== t) {
            var n = Vf(t);
            if (null !== n)
                if ("_" !== n.spmc || "" !== n.actionName) switch (i.setCurSpiderElement(t), t.getAttribute(gf)) {
                    case "none":
                        break;
                    case "transferAction":
                        i.transferAction(n);
                    ...
                    default:
                        var o, r = Bf(t, Nf);
                        r instanceof HTMLAnchorElement ? (o = i.transferActionBy(r.href, n)) === kf ? e.preventDefault() : (m.emit("pageNavigate"), r.href = o) : i.trackAction(n)
                }
        }
    }, !0)
}
...
"object" == typeof window && ("IntersectionObserver" in window && "IntersectionObserverEntry" in window && "intersectionRatio" in window.IntersectionObserverEntry.prototype ? "isIntersecting" in window.IntersectionObserverEntry.prototype || Object.defineProperty(window.IntersectionObserverEntry.prototype, "isIntersecting", {
    ...
    for (var e = window.document, t = Yd(e); t;) t = Yd(e = t.ownerDocument);
    return e
}(), Jd = [], Fd = Vd = null, j.prototype.THROTTLE_TIMEOUT = 100, j.prototype.POLL_INTERVAL = null, j.prototype.USE_MUTATION_OBSERVER = !0, j._setupCrossOriginUpdater = function () {
    ...
    e && -1 == this._monitoringDocuments.indexOf(t) && (n = this._checkForIntersections, o = r = null, this.POLL_INTERVAL ? r = e.setInterval(n, this.POLL_INTERVAL) : (Xd(e, "resize", n, !0), Xd(t, "scroll", n, !0), this.USE_MUTATION_OBSERVER && "MutationObserver" in e && (o = new e.MutationObserver(n)).observe(t, {
        attributes: !0,
        childList: !0,
        characterData: !0,
        subtree: !0
        ...
        var e = t.defaultView;
        e && (r && e.clearInterval(r), Zd(e, "resize", n, !0)),
            Zd(t, "scroll", n, !0),
            o && o.disconnect()
    ...
    var o, e, t = this._monitoringDocuments.indexOf(r); - 1 != t && (o = this.root && this.root.ownerDocument || Hd, this._observationTargets.some(function (e) {
        ...
        return !1
    }) || (e = this._monitoringUnsubscribes[t], this._monitoringDocuments.splice(t, 1), this._monitoringUnsubscribes.splice(t, 1), e(), r != o && (t = Yd(r)) && this._unmonitorIntersections(t.ownerDocument)))
    ...
    var a, s;
    !this.root && Vd && !Fd || (a = this._rootIsInDom(), s = a ? this._getRootRect() : th(), this._observationTargets.forEach(function (e) {
        var t = e.element,
            n = eh(t),
    ...
    var e, t;
    return t = this.root ? eh(this.root) : (t = Hd.documentElement, e = Hd.body, {
        top: 0,
        left: 0,
    ...
    var e = Jd.indexOf(this); - 1 != e && Jd.splice(e, 1)
}, window.IntersectionObserver = j, window.IntersectionObserverEntry = $d));
var ah = [];
...
function ch(n) {
    function r(e) {
        e.forEach(function (e) {
            ...
            e.intersectionRatio > t && (e.target.setAttribute(wf, "impressed"), n.trackImpression(e.target), Gd.unobserve(e.target))
        })
    }
    var o = {
    ...
    Jf(function () {
        var e, t;
        Gr("impression") && (Gd = new IntersectionObserver(r, o), e = "[" + wf + "]", t = function (e) {
            var t;
...
function uh(e) {
    Jf(function () {
        Fr("spider") || (e.refreshTimestamp(), e.trackPageview())
    })
}
var ph = {
    spma: void 0,
...
function fh(t) {
    ...
    function i(e, t) {
        var n = Zf(),
            r = n.spma,
            n = n.spmb;
        r && n && (lh(r, n), o || (t && t(), o = !0), L.emit("PAGE_ENTER", {
            type: "PAGE_ENTER",
            startTime: k(),
            spma: r,
            spmb: n,
    ...
    L.on("PAGE_ENTER", function (e) {
        e.spma && e.spmb && (n = e, Pf && !sessionStorage.getItem(Of) && sessionStorage.setItem(Of, e.spma + "_" + e.spmb))
    }),
                ...
                Go(function () {
                    ke(function () {
                        var e = Zf(),
                            t = e.spma,
                            e = e.spmb;
                        t && e && (t !== ph.spma || e !== ph.spmb) && (t = k(), L.emit("PAGE_LEAVE", {
                            type: "PAGE_LEAVE",
                            startTime: t,
                            reason: "SPMAB_CHANGE"
                        }))
...
function hh() {
    ...
    this.hooks.push("beforeNavigate", function (e, t) {
        var n, r = e.url,
            o = e.value,
            i = e.context;
        "weidianbuyer:" === Rf(r).protocol ? ((n = r) && 0 <= n.indexOf("weidianbuyer://wdb/webview") && (n = Mf("url", r)) ? (i = i.transferActionBy(n, o), e.url = jt(r, {
            url: i
        })) : (a.trackAction(o), e.url = r), t && t(new Error(""))) : t && t()
    })
}
...
function _h() {
    ...
    this.hooks.push("beforeNavigate", function (e, t) {
        ...
        jr() ? ("thirdApp" !== Mf("invoke") && "thirdApp" !== Mf("vc_invoke") || (i = jt(i, {
            invoke: "thirdApp"
        }), e.url = i), "0" === Mf("urlIntercept", i) ? t && t() : (n = (n = i).match(mh) || n.match(vh), "wx_zhuanzhuan" !== Mf("vc_minip") && n ? (o = i, r = yh[(r = n)[1]].minaPath + r[2], (o = (o = (o = o).match(/^[^\?#]*\?([^#]*)/)) ? o[1] : "") && (r += "&" + o), o = r, r = a, a = s, "item" === (n = n)[1] && (r.actionName = x.ITEM, r.actionArgs = d({}, r.actionArgs, {
            itemId: n[2]
        })), "user" === n[1] && (r.actionName = x.SHOP, r.actionArgs = d({}, r.actionArgs, {
            shopId: n[2]
        })), a.trackAction(r), (n = _.jWeixin || _.wx) && (n.miniProgram[gh.NAVIGATE_TO]({
            url: o
        }), n.miniProgram[gh.SWITCH_TAB]({
            url: o
        })), e.url = "javascript:", t && t(new Error(""))) : (e.url = i, t && t()))) : t && t()
    })
}
...
function wh() {
    this.hooks.push("beforeNavigate", function (e, t) {
        try {
            _.multiDomainRuleMap && Qr("spider") && !xr() && !Lr() && (e.url = $a(e.url, _.multiDomainRuleMap)), !_.multiDomainRuleMap || Fr("privateDomain") || xr() || (jr() || (e.url = za(e.url, {
    ...
    hh.call(this),
        function () {
            ...
            this.hooks.push("beforeNavigate", function (e, t) {
                var n = e.url,
                    r = e.value;
                xo(n) ? t && t() : (o.trackAction(r), e.url = n, t && t(new Error("")))
            })
        }.call(this),
        _h.call(this),
        wh.call(this),
...
function Eh(e) {
    n = /^visual-window:([\S\s]+)$/;
    var t, n = (n = _.name.match(n) || _.parent && _.parent.name && _.parent.name.match(n)) && n[1].split("|"),
        r = ["assets.geilicdn.com", "assets.pre.geilicdn.com", "assets.daily.geilicdn.com", "h5.dev.weidian.com"];
...
function Ih(t) {
    ...
    n.onreadystatechange = function () {
        var e;
        4 == n.readyState && (200 == n.status ? (e = n.responseText, t.success(function (e) {
            try {
                var t = JSON.parse(e);
        ...
        n.open("POST", t.url, !0),
        n.withCredentials = !0,
        t && (t.timeout && (n.timeout = t.timeout), n.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), n.setRequestHeader("Accept", "application/json")),
        t.data instanceof FormData || (t.data = function (e) {
            var t, n = [],
                r = ["string", "boolean", "number"];
            for (t in e)
                if ("" !== t && -1 < r.indexOf(typeof e[t])) switch (e[t]) {
                    case !0:
...
D.getInstance = function () {
    ...
    D.prototype.tap = function (e) {
        ...
        n && (t = n.startTime, n = n.logCount, this.setStorageData({
            startTime: t,
            logCount: n + e
        }))
    },
        ...
        Os(function (e) {
            ...
            try {
                var t = Ch.getTapperData(),
                    n = (t && Ch.sendTapData(e, t), Ch.changeTapperSend(), Ch.initTapperData(), Ch.getLockLogCount());
                0 < n && (Ch.tap(n), Ch.cleanLockLog())
            } catch (e) { }
        })
    }),
        L.on("report_prev_data", function () {
...
Bh = "0.0.0",
    N = "browser",
    Uh = null, /MQQBrowser\//i.test(o) && (N = "qqbrowser"), /MicroMessenger/i.test(o) && (N = "wx"), /QQ\/([\d\.]+)/i.test(o) && (N = "qq"), /WDAPP\(/.test(o) && (N = "app"), /WDAPP\(WDBuyer/.test(o) && (N = "vbuyer", Uh = o.match(/WDAPP\(WDBuyer\/([\d\.]+)/)), /WDAPP\(WD\//.test(o) && (N = "kdweidian", Uh = o.match(/WDAPP\(WD\/([\d\.]+)/));
var Dh, Nh, Rh, qh, Mh, o = {
...
}, Uh = (Dh = new Pe, ku() && f([nl, Qu, Hu, Np, tl], function (e) {
    return Dh.use(e)
}), {
    use: function (e) {
        Dh.use(e)
    ...
    Bh = ((Nh = new Ne).use(uf), Nh.use(pf), Rh = {
        option: function (e) {
            return Nh.option(e),
                Rh
        },
    ...
    N = (qh = new r, md && qh.use(jh), f([dh, bh, kh, Th], function (e) {
        return qh.use(e)
    }), {
        use: function (e) {
            return qh.use(e)
    ...
    n = (Mh = new nc, f([tu, vc, Bc, Zc], function (e) {
        return Mh.use(e)
    }), {
        use: function (e) {
            Mh.use(e)
